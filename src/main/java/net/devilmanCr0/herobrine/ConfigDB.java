...
import net.devilmanCr0.herobrine.misc.CustomID;
...
public class ConfigDB {
	...
	public boolean OnlyWalkingMode = true;
	...
	public String DeathMessage = "I am a good guy, I promise";
	...
	public int BuildPyramidOnChunkPercentage = 1;
	...
	public boolean BuildTemples = false;
	public int BuildTempleOnChunkPercentage = 1;
	public boolean UseArtifactBow = false;
	public boolean UseArtifactSword = false;
	public boolean UseArtifactApple = false;
	...
	public int BuildInterval = 720000;
	...
	public boolean UseIgnorePermission = false;
	public String HerobrineUUID = "9f9301dc-7c37-4d1c-b58a-2bc45f2f5cbf";
	...
	public void Startup() {
		...
		if (!config.contains("config.ShowRate")) {
			...
			useWorlds.add("world");
			useMessages.add("do you hear yourself breathing");
			useMessages.add("i see you");
			useMessages.add("death is imminent");
			useMessages.add("I am a good guy I promise");
			useMessages.add("Crushing your gem");
			useSignMessages.add("behind you");
			useSignMessages.add("what happens when you go to sleep?");
			useSignMessages.add("I love watching you");
			useBookMessages.add("i'll see you in the grave");
			useBookMessages.add("notch is so ugly");
			...
			config.set("config.DeathMessage", "go to sleep");
			...
			config.set("config.BuildPyramidOnChunkPercentage", 1);
			...
			config.set("config.BuildInterval", 720000);
			config.set("config.BuildTemples", false);
			config.set("config.BuildTempleOnChunkPercentage", 1);
			config.set("config.UseArtifacts.Bow", false);
			config.set("config.UseArtifacts.Sword", false);
			...
			config.set("config.HerobrineUUID", "9f9301dc-7c37-4d1c-b58a-2bc45f2f5cbf");
			config.set("config.HerobrineName", "Herobrine");
			config.set("config.HerobrineWorldName", "world_herobrine_graveyard");
			config.set("config.ShowInTabList", true);
