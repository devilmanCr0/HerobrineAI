...
public class CmdPluginReport extends SubCommand {
				...
				public void run() {
					...
					if(response.equals("0"))
						...
						sendMessage(player, ChatColor.RED + "Your report was not submitted because this version of Herobrine does not " +
								...
								"plugin at: https://www.devilmanCr0.net/Herobrine/download.php");
						...
						sendMessage(player, ChatColor.RED + "Your report was not submitted because this version of Herobrine is no " +
								...
								"https://www.devilmanCr0.net/Herobrine/download.php");
						...
						sendMessage(player, ChatColor.GREEN + "Your report was successfully submitted. For further assistance, please " +
								"post on our forum at https://www.devilmanCr0.net/forum/ and " +
	...
	public String helpDesc() {
		return ChatColor.GREEN + "See devilmanCr0.net/Herobrine/internalBugReporting.php for documentation on this command";
	}
	...
	private String sendBugReport(Player player, String[] messageWords) {
		...
		try {
			...
			try {
				...
				URL submitURL = new URL("https://www.devilmanCr0.net/Herobrine/pluginBugReporter.php");
	...
	private String getServerIP() {
		...
		URL ipFetchURL;
		try {
			ipFetchURL = new URL("https://www.devilmanCr0.net/Herobrine/pluginIPFetcher.php");
